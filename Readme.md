...
5. add treesitter parser in [list](https://github.com/dongdongbh/nvim.conf/blob/febfb71e3d5d4939e7fcbc62bf5a9debbc4dea8e/lua/user/treesitter.lua#L23), install treesitter for programe languages by `:TSInstall all`
